...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('LifeSure-1.0.0/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
        <link href="{{ asset('LifeSure-1.0.0/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
        <!-- <link href="../../../public/LifeSure-1.0.0/css/bootstrap.min.css" rel="stylesheet"> -->
        <link href="{{ asset('LifeSure-1.0.0/css/bootstrap.min.css') }}" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{ asset('LifeSure-1.0.0/css/style.css') }}" rel="stylesheet">
        <link href="{{ asset('LifeSure-1.0.0/lib/animate/animate.css') }}" rel="stylesheet">
    </head>
    ...
    <body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light"> 
                    <a href="#" class="navbar-brand p-0">
                        ...
                        <img src="{{ asset('LifeSure-1.0.0/img/about-1.png') }}" alt="Logo">
                    </a>
        ...
        <script src="{{ asset('LifeSure-1.0.0/lib/wow/wow.min.js') }}"></script>
        <script src="{{ asset('LifeSure-1.0.0/lib/easing/easing.min.js') }}"></script>
        <script src="{{ asset('LifeSure-1.0.0/lib/waypoints/waypoints.min.js') }}"></script>
        <script src="{{ asset('LifeSure-1.0.0/lib/counterup/counterup.min.js') }}"></script>
        <script src="{{ asset('LifeSure-1.0.0/lib/lightbox/js/lightbox.min.js') }}"></script>
        <script src="{{ asset('LifeSure-1.0.0/lib/owlcarousel/owl.carousel.min.js') }}"></script>
